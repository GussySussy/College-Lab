...
class Calculator extends JFrame implements ActionListener {
    ...
    JButton addButton, subButton, mulButton, divButton, modButton, pointButton, equButton, delButton, clrButton,
            negButton;
    JPanel panel;
    ...
    public Calculator() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            numberButtons[i].setBorder(BorderFactory.createLineBorder(Color.orange, 2));
        }
